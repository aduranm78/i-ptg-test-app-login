...
public class Routes extends RouteBuilder {
  ...
  public void configure() throws Exception {
    restConfiguration()
      ...
      String erpUri = "https://5298967-sb1.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=575&deploy=1&bridgeEndpoint=true&throwExceptionOnFailure=false";
      String NSUri = "https://5298967-sb1.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=575&deploy=1";
...
//          .type(Customer.class).outType(CustomerSuccess.class)
  ...
  //          .type(Customer.class).outType(CustomerSuccess.class)
    ...
    from("direct:request")
      ...
      .toD("https://5298967-sb1.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=575&deploy=1&bridgeEndpoint=true&throwExceptionOnFailure=false")
      .streamCaching()
